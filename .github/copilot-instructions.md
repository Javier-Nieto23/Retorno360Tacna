...
- En este proyecto, los formularios deben generarse con su archivo de diseño separado para no mezclar lógica con UI; se prefiere un parcial de diseño/estilo además del .Designer cuando aplique.
