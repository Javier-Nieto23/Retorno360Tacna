...
namespace Retorno360Tacna.FORMS
{
    public partial class MainMenu
    {
        ...
        private IEnumerable<Button> ObtenerBotonesMenuConIcono()
        {
            ...
            yield return btnCluster;
            yield return btnInventarios;
            yield return btnReporteAd;
            ...
            yield return btnSubMenuCumplimiento;
        ...
        private void AplicarEscalaMenuLateral()
        {
            ...
            panelSubMenuCluster.Height = menuClusterExpandido ? ObtenerAlturaSubmenu(panelSubMenuCluster) : 0;
