...
namespace Retorno360Tacna.FORMS
{
    public partial class FrmConfiguracion : Form
    {
        ...
        private static string ConexionPortalWeb => SERVICES.ConfiguracionService.GetRailwayConnectionString();
        ...
        public FrmConfiguracion(ConexionInfo conexion, Usuario? usuario = null)
        {
            ...
            // El acceso a 'Conexiones' se gestiona desde el menú principal de configuración.
        }
