...
namespace Retorno360Tacna.FORMS
{
    public partial class FrmConfiguracionMenu : Form
    {
        ...
        public event EventHandler? AbrirUsuariosRazon;

        public event EventHandler? AbrirUsuarioEmpresaSolicitado;
        ...
        private void btnUsuarioEmpresa_Click(object sender, EventArgs e)
        {
            AbrirUsuarioEmpresaSolicitado?.Invoke(this, EventArgs.Empty);
        }
